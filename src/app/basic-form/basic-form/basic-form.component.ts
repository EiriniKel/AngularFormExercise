...
export class BasicFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.form = new FormGroup({
      firstName: new FormControl('eirini', [Validators.required,Validators.minLength(3)]),
      lastName: new FormControl('kelidou', Validators.required),
    ...
    this.form.get('firstName').valueChanges.subscribe(console.log)
    this.form.get('lastName').valueChanges.subscribe(console.log)
